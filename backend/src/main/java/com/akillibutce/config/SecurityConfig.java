...
import com.akillibutce.security.JwtAuthFilter;
import com.akillibutce.security.KullaniciDetaylariServisi;
...
public class SecurityConfig {
    ...
    @Bean
    public DaoAuthenticationProvider kimlikDogrulamaSaglayici() {
        DaoAuthenticationProvider provider = new DaoAuthenticationProvider();
        provider.setUserDetailsService(kullaniciDetaylariServisi);
        provider.setPasswordEncoder(sifreKodlayici());
        return provider;
    }
    ...
    @Bean
    public SecurityFilterChain guvenlikFiltresi(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/api/butce-limitleri/**").hasAuthority("ROLE_PREMIUM_USER")
