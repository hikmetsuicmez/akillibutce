...
export default function Premium() {
  ...
  const planSec = (tip) => {
    // Gercek odeme entegrasyonu icin buraya ekleme yapilmali
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      <div className="text-center">
        <h1 className="text-3xl font-bold text-gray-900">Planları Karşılaştır</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="card border-2 border-gray-200">
          <div className="mb-6">
            ...
            <p className="text-gray-500 text-sm mt-1">Temel bütçe takibi</p>
          </div>
        ...
        <div className="card border-2 border-primary-500 relative">
          ...
          <div className="mb-6">
            ...
            <p className="text-gray-500 text-sm mt-1">Aylık abonelik</p>
          </div>
          <ul className="space-y-3 mb-8">
        ...
        <div className="card border-2 border-gray-200">
          <div className="mb-6">
            ...
            <p className="text-gray-500 text-sm mt-1">≈ ₺41.58/ay</p>
          </div>
          <ul className="space-y-3 mb-8">
            {premiumOzellikler.map((o, i) => (
              <li key={i} className="flex items-start gap-2 text-sm text-gray-600">
